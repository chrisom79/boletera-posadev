...
// Reached via a Laravel-signed URL generated by JobPollingService, not auth:api:
// the signature (scoped to this exact event/job, short-lived) is the authorization,
// since a plain browser download click can't carry the app's JWT auth header.
$router->get(
